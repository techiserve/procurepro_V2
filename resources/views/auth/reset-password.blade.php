...
<div class="container">
    ...
    <div class="right">
        <h3 style="font-family: 'Gilroy-Bold', Arial, sans-serif;" >Reset Password</h3>
        ...
        @csrf
            ...
            @if($errors->has('email'))
                <div class="mt-2 invalid-feedback d-block">
                    {{ $errors->first('email') }}
                </div>
            @endif
            ...
            <input type="submit" value="Reset" style="font-family: 'Gilroy-Bold', Arial, sans-serif;">
