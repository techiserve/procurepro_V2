  ...
  <div class="animated fadeIn">
    <div class="row">
      <div class="col-sm-12">
       ...
       <form method="POST" action="/procurement/{{$purchaseorder->id}}/sendback">
       @csrf
       @method('put')
        <div class="card">
        ...
        <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="grower_address">Reason</label>
            ...
            <a href='/procurement/{{$purchaseorder->id}}/accept' class='btn btn-success' style='color: white;'>
        ...
        <div class="card">
            ...
            <table class="table table-responsive-sm table-bordered table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>          
                  ...
                  <a href="{{ asset('/storage/uploads/'.$purchaseorder->invoice) }}" target="_blank"class='btn btn-info btn-sm' style='color: white;'>
                ...
                <tr>         
                  ...
                  <a href="{{ asset('/storage/uploads/'.$purchaseorder->jobcardfile) }}" target="_blank"class='btn btn-info btn-sm' style='color: white;'>
                      <span class='fa fa-pencil'></span>
          ...
          <div class="modal fade" id="emailCopy" tabindex="-1"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <form method="POST" action="/procurement/{{$purchaseorder->id}}/reject">
                   @csrf
                  @method('put')
										<div class="form-group">
