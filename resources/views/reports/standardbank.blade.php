    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="standardBankReportTable">
                    <thead class="table-light text-center">
                        <tr>
                            <th class="text-center">RICIPIENT NAME</th>
                            <th class="text-center">RICIPIENT ACCOUNT</th>
                            <th class="text-center">RICIPIENT ACCOUNT TYPE</th>
                            <th class="text-center">BRANCH</th>
                            <th class="text-center">AMOUNT</th>
                            <th class="text-center">OWN REFERENCES</th>
                            <th class="text-center">RICIPIENT REFERENCES</th>
                        </tr>
                    </thead>
                    <tbody>
...
document.addEventListener("DOMContentLoaded", function () {
    const table = new DataTable('#standardBankReportTable', {
        responsive: true,
        paging: true,
        searching: true,
        ordering: true,
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize Select2 inside modal with Bootstrap 5 theme
    $('.js-example-basic-single').select2({
        theme: 'bootstrap-5',
        dropdownParent: $('#filterModal')
    });

    // Re-init Select2 every time the modal opens (ensures correct dropdown placement)
