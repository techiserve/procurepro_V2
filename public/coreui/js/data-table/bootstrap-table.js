...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        icons: {
            paginationSwitchDown: 'fa-level-down icon-chevron-down',
            paginationSwitchUp: 'fa-level-up icon-chevron-up',
            refresh: 'fa-refresh icon-refresh',
            toggle: 'fa-list-alt icon-list',
    ...
    $(function () {
        $('[data-toggle="tables"]').bootstrapTable();
    });
})(jQuery);